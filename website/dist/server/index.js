globalThis.__VINEXT_LAZY_CHUNKS__ = ["assets/layout-segment-context-C7aZlf2W.js","assets/RacoreProductApp-Cnxm6kb6.js","assets/page-DFPyQxcH.js"];
...
function getDraftSecret() {
	return "9fdb08cf-485d-4241-b4ab-537802ba7511";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "12687abe-b36a-4cb6-b498-64e762ce8fac";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "12687abe-b36a-4cb6-b498-64e762ce8fac") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "12687abe-b36a-4cb6-b498-64e762ce8fac",
		rootBoundaryId
	});
}
/**
